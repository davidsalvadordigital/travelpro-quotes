...
const badgeVariants = cva(
  "inline-flex items-center justify-center rounded-full border border-transparent px-3.5 py-1 text-[11px] font-black uppercase tracking-[0.12em] w-fit whitespace-nowrap shrink-0 [&>svg]:size-3.5 gap-2 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 transition-all duration-300 overflow-hidden ring-2 ring-inset",
  {
    variants: {
      variant: {
